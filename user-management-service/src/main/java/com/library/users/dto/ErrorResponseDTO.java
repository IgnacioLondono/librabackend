...
public class ErrorResponseDTO {
    ...
    @Schema(description = "Mensaje descriptivo del error", example = "El email ya está registrado", requiredMode = Schema.RequiredMode.REQUIRED)
    private String message;

    @Schema(description = "Ruta del endpoint donde ocurrió el error", example = "/api/users/register", requiredMode = Schema.RequiredMode.REQUIRED)
    private String path;
